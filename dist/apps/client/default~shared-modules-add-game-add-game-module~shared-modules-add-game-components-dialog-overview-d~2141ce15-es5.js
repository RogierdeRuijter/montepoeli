...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~shared-modules-add-game-add-game-module~shared-modules-add-game-components-dialog-overview-d~2141ce15"], {
  ...
  /***/
  function srcAppSharedModulesAddGameComponentsDialogDataDialogDataComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DialogDataComponent", function () {
    ...
    var _static_files_enums__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../../static-files/enums */
    "./src/app/shared/static-files/enums.ts");
    /* harmony import */


    var _services_dialog_data_dialog_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../services/dialog-data/dialog-data.service */
    ...
    var _async_components_async_base_component_async_base_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../async/components/async-base-component/async-base.component */
    "./src/app/shared/modules/async/components/async-base-component/async-base.component.ts");
    /* harmony import */


    var _home_modules_game_stores_user_store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../../home/modules/game/stores/user.store */
    "./src/app/shared/modules/home/modules/game/stores/user.store.ts");
    /* harmony import */


    var _game_result_game_result_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./game-result/game-result.component */
    "./src/app/shared/modules/add-game/components/dialog-data/game-result/game-result.component.ts");

    var DialogDataComponent =
    /*#__PURE__*/
    function (_async_components_asy) {
      _inherits(DialogDataComponent, _async_components_asy);

      var _super = _createSuper(DialogDataComponent);

      function DialogDataComponent(dialogRef, data, userStore, dialogDataService, translateService) {
        var _this;

        _classCallCheck(this, DialogDataComponent);

        _this = _super.call(this);
        _this.dialogRef = dialogRef;
        _this.data = data;
        _this.userStore = userStore;
        _this.dialogDataService = dialogDataService;
        _this.translateService = translateService;
        _this.winners = [_static_files_enums__WEBPACK_IMPORTED_MODULE_2__["Winners"].WHITE, _static_files_enums__WEBPACK_IMPORTED_MODULE_2__["Winners"].BLACK, _static_files_enums__WEBPACK_IMPORTED_MODULE_2__["Winners"].DRAW];
        _this.Sides = _static_files_enums__WEBPACK_IMPORTED_MODULE_2__["Sides"];
        _this.winnerOptions = [];
        return _this;
      }

      _createClass(DialogDataComponent, [{
        key: "ngOnInit",
        ...
        value: function cancelEventHandler() {
          this.dialogRef.close('cancelButton');
        }
      }, {
        key: "determineAvailableUsersForSelect",
        value: function determineAvailableUsersForSelect(selectName) {
          return this.dialogDataService.determineAvailableUsersForSelect(this.users, this.data, selectName);
        }
      }, {
        key: "ifAllFieldsAreNotField",
        value: function ifAllFieldsAreNotField() {
          return !this.dialogDataService.allFieldsAreDefined(this.data);
        }
      }, {
        key: "usersAreNotDefined",
        value: function usersAreNotDefined() {
          return !this.dialogDataService.userAreDefined(this.data);
        }
      }, {
        key: "fieldUpdateHandler",
        value: function fieldUpdateHandler(game) {
          var _a, _b;
      ...
      return DialogDataComponent;
    }(_async_components_async_base_component_async_base_component__WEBPACK_IMPORTED_MODULE_5__["AsyncBaseComponent"]);

    DialogDataComponent.ɵfac = function DialogDataComponent_Factory(t) {
      return new (t || DialogDataComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_home_modules_game_stores_user_store__WEBPACK_IMPORTED_MODULE_6__["UsersStore"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_dialog_data_dialog_data_service__WEBPACK_IMPORTED_MODULE_3__["DialogDataService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslateService"]));
    };

    DialogDataComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DialogDataComponent,
      selectors: [["app-dialog-data"]],
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]],
      decls: 1,
      vars: 7,
      consts: [[3, "data", "disabled", "winnerFieldHidden", "usersBlack", "usersWhite", "winnerOptions", "winners", "cancelEvent", "fieldUpdateEvent"]],
      template: function DialogDataComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ui-game-result", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cancelEvent", function DialogDataComponent_Template_ui_game_result_cancelEvent_0_listener() {
            return ctx.cancelEventHandler();
          })("fieldUpdateEvent", function DialogDataComponent_Template_ui_game_result_fieldUpdateEvent_0_listener($event) {
            return ctx.fieldUpdateHandler($event);
          });
      ...
      directives: [_game_result_game_result_component__WEBPACK_IMPORTED_MODULE_7__["GameResultComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DialogDataComponent, [{
        ...
        return [{
          ...
          type: _home_modules_game_stores_user_store__WEBPACK_IMPORTED_MODULE_6__["UsersStore"]
        }, {
          type: _services_dialog_data_dialog_data_service__WEBPACK_IMPORTED_MODULE_3__["DialogDataService"]
        }, {
  ...
  /***/
  function srcAppSharedModulesAddGameComponentsDialogDataGameResultGameResultComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GameResultComponent", function () {
    ...
    var _translate_directives_translate_directive__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _form_components_drop_down_drop_down_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../../../form/components/drop-down/drop-down.component */
    "./src/app/shared/modules/form/components/drop-down/drop-down.component.ts");
    /* harmony import */


    var _grid_directives_grid_row_directive__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../../../grid/directives/grid-row.directive */
    "./src/app/shared/modules/grid/directives/grid-row.directive.ts");
    /* harmony import */


    var _button_components_button_button_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../../../button/components/button/button.component */
    "./src/app/shared/modules/button/components/button/button.component.ts");
    /* harmony import */


    var _grid_directives_grid_column_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    function () {
      function GameResultComponent() {
        _classCallCheck(this, GameResultComponent);
      ...
      _createClass(GameResultComponent, [{
        key: "cancel",
    ...
    GameResultComponent.ɵfac = function GameResultComponent_Factory(t) {
      return new (t || GameResultComponent)();
    };

    GameResultComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: GameResultComponent,
      selectors: [["ui-game-result"]],
      viewQuery: function GameResultComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function GameResultComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function GameResultComponent_Template_app_drop_down_valueChange_5_listener($event) {
            return ctx.data.white = $event;
          })("valueChange", function GameResultComponent_Template_app_drop_down_valueChange_5_listener() {
            return ctx.fieldUpdated();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function GameResultComponent_Template_app_drop_down_valueChange_7_listener($event) {
            return ctx.data.black = $event;
          })("valueChange", function GameResultComponent_Template_app_drop_down_valueChange_7_listener() {
            return ctx.fieldUpdated();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function GameResultComponent_Template_app_drop_down_valueChange_9_listener($event) {
            return ctx.data.winner = $event;
          })("valueChange", function GameResultComponent_Template_app_drop_down_valueChange_9_listener() {
            return ctx.fieldUpdated();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clickEvent", function GameResultComponent_Template_app_button_clickEvent_11_listener() {
            return ctx.cancel();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("clickEvent", function GameResultComponent_Template_app_button_clickEvent_12_listener() {
            return ctx.save();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GameResultComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSharedModulesAddGameComponentsDialogOverviewDialogOverviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DialogOverviewComponent", function () {
    ...
    var _dialog_data_dialog_data_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../dialog-data/dialog-data.component */
    "./src/app/shared/modules/add-game/components/dialog-data/dialog-data.component.ts");
    /* harmony import */
    ...
    var _home_modules_game_factories_game_factory__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../../home/modules/game/factories/game.factory */
    "./src/app/shared/modules/home/modules/game/factories/game.factory.ts");

    var DialogOverviewComponent =
    /*#__PURE__*/
    function () {
      function DialogOverviewComponent(dialog, utilService, router) {
        _classCallCheck(this, DialogOverviewComponent);
      ...
      _createClass(DialogOverviewComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.openDialog();
        }
        ...
        value: function openDialog() {
          ...
          var dialogRef = this.dialog.open(_dialog_data_dialog_data_component__WEBPACK_IMPORTED_MODULE_1__["DialogDataComponent"], {
            data: {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (_this3.addEventIsReceived(result)) {
              _this3.addEvent.emit(result);
            }

            if (result === 'cancelButton') {
              _this3.cancelEvent.emit();
            }
        ...
        key: "closeDialogWhenTheUrlChanges",
        value: function closeDialogWhenTheUrlChanges() {
          var _this4 = this;
          ...
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.unsubscriber$)).subscribe(function () {
            var _a;

            return (_a = _this4.dialog) === null || _a === void 0 ? void 0 : _a.closeAll();
          });
        }
      }, {
        key: "addEventIsReceived",
        value: function addEventIsReceived(result) {
          var _a;
    ...
    DialogOverviewComponent.ɵfac = function DialogOverviewComponent_Factory(t) {
      return new (t || DialogOverviewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_util_util_service__WEBPACK_IMPORTED_MODULE_2__["UtilService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]));
    };

    DialogOverviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DialogOverviewComponent,
      ...
      decls: 0,
      vars: 0,
      template: function DialogOverviewComponent_Template(rf, ctx) {},
      encapsulation: 2
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DialogOverviewComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSharedModulesAddGameServicesDialogDataDialogDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DialogDataService", function () {
    ...
    var DialogDataService =
    /*#__PURE__*/
    function () {
      function DialogDataService(utilService) {
        _classCallCheck(this, DialogDataService);

        this.utilService = utilService;
      }

      _createClass(DialogDataService, [{
        key: "determineAvailableUsersForSelect",
        value: function determineAvailableUsersForSelect(users, game, selectName) {
          var chosenUserName = [];
          ...
          return users.filter(function (user) {
            return chosenUserName.includes(user.name) === false;
          });
        }
      }, {
        key: "allFieldsAreDefined",
        value: function allFieldsAreDefined(game) {
          return !this.utilService.isNullOrUndefined(game.white) && !this.utilService.isNullOrUndefined(game.black) && !this.utilService.isNullOrUndefined(game.winner);
        }
      }, {
        key: "userAreDefined",
        value: function userAreDefined(game) {
    ...
    DialogDataService.ɵfac = function DialogDataService_Factory(t) {
      return new (t || DialogDataService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_util_util_service__WEBPACK_IMPORTED_MODULE_1__["UtilService"]));
    };

    DialogDataService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: DialogDataService,
      factory: DialogDataService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DialogDataService, [{
  ...
  /***/
  function srcAppSharedModulesFormComponentsDropDownDropDownComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _option_name_option_name_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./option-name/option-name.component */
    "./src/app/shared/modules/form/components/drop-down/option-name/option-name.component.ts");

    var _c0 = ["select"];

    function DropDownComponent_mat_option_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("iconClickEvent", function DropDownComponent_mat_option_4_Template_app_option_name_iconClickEvent_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r23);

          var ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r22.removeOption();
        });
    ...
    function () {
      ...
      _createClass(DropDownComponent, [{
        ...
        key: "getOptionName",
        value: function getOptionName(option) {
    ...
    DropDownComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      outputs: {
        removeOptionEvent: "removeOptionEvent",
      ...
      decls: 5,
      vars: 5,
      consts: [[3, "appTranslate"], [3, "ngModel", "id", "disabled", "valueChange", "ngModelChange"], ["select", ""], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [3, "showIcon", "value", "id", "iconClickEvent"]],
      template: function DropDownComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function DropDownComponent_Template_mat_select_valueChange_2_listener($event) {
            return ctx.valueChange.emit($event);
          })("ngModelChange", function DropDownComponent_Template_mat_select_ngModelChange_2_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DropDownComponent, [{
        ...
        valueAccessor: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
          args: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], {
            "static": true
          }]
        }],
        select: [{
  ...
  /***/
  function srcAppSharedModulesFormComponentsDropDownOptionNameOptionNameComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OptionNameComponent", function () {
      return OptionNameComponent;
    });
    /* harmony import */
    ...
    var _icon_components_icon_icon_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../../../icon/components/icon/icon.component */
    "./src/app/shared/modules/icon/components/icon/icon.component.ts");

    function OptionNameComponent_span_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function OptionNameComponent_app_icon_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-icon", 2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function OptionNameComponent_app_icon_2_Template_app_icon_click_0_listener($event) {
    ...
    var OptionNameComponent =
    /*#__PURE__*/
    function () {
      function OptionNameComponent() {
        _classCallCheck(this, OptionNameComponent);
      ...
      _createClass(OptionNameComponent, [{
        key: "iconClick",
    ...
    OptionNameComponent.ɵfac = function OptionNameComponent_Factory(t) {
      return new (t || OptionNameComponent)();
    };

    OptionNameComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: OptionNameComponent,
      selectors: [["app-option-name"]],
      inputs: {
        value: "value",
        showIcon: "showIcon"
      },
      ...
      decls: 3,
      vars: 3,
      consts: [[4, "ngIf"], ["class", "float", 3, "iconSize", "icon", "click", 4, "ngIf"], [1, "float", 3, "iconSize", "icon", "click"]],
      template: function OptionNameComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _icon_components_icon_icon_component__WEBPACK_IMPORTED_MODULE_3__["IconComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](OptionNameComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSharedModulesHomeModulesGameFactoriesGameFactoryTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GameFactory", function () {
      return GameFactory;
    });
  ...
  function srcAppSharedModulesHomeModulesGameStoresUserStoreTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_shared_services_stor) {
      ...
      var _super2 = _createSuper(UsersStore);
...
//# sourceMappingURL=default~shared-modules-add-game-add-game-module~shared-modules-add-game-components-dialog-overview-d~2141ce15-es5.js.map